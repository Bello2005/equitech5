<!DOCTYPE html><html lang="es" class="h-full bg-slate-50"><head>
    <meta charset="UTF-8">
    ...
    <?php
    // Preferir el CSS compilado localmente en producción
    ...
    if (file_exists($compiledTailwind)) {
        ...
        // En desarrollo rápido todavía podemos usar el CDN
